...
class GmJob extends Job implements QueueJobInterface
{
    ...
    public function __construct(Container $container, GmWorker $worker, $queue)
    {
        $this->container = $container;
        $this->worker = $worker;
        $this->worker->addFunction($queue, [$this, 'onGmJob']);
    }
